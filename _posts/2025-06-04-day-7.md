...
reflection: |
  I gained a better understanding of the machine learning example that we have been going over and how pictures are used to train the model. I also dove deeper into key terms like loss functions and gradients for example. Loss function is how far off the model's predictions are from the correct answer, and gradients are another way of saying "rate of change." Then the machine learning project showed me another example of what the code should look like. I just need to take the time to go over and understand the code.
---
